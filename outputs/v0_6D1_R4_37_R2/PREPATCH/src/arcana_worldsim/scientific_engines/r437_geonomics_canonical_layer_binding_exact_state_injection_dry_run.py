...
def _payload_range_audit(root: Path, manifest: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "all_hashes_match": all(r.get("hash_match") for r in rows),
        "all_finite_and_native_geonomics_range_0_1": all_ok,
...
def _j21_native_layer_binding(
    ...
    if not (
        ...
        and range_audit["all_finite_and_native_geonomics_range_0_1"]
    ):
        return {
            "status": "BLOCKED_R437_J21_IDENTITY_VALUES_NOT_NATIVE_GEONOMICS_RANGE",
            "geonomics_version": version,
    ...
    payload_records = payload_manifest["records"]
    records = []
    ...
    return {
        ...
        "canonical_layer_binding_count": 151 * passed,
        "automatic_rescaling_performed": False,
...
def build(root: Path) -> dict[str, Any]:
    ...
    checks = {
        ...
        "j21_identity_values_native_0_1":
            j21.get("range_audit", {}).get(
                "all_finite_and_native_geonomics_range_0_1"
            ) is True,
        "j21_four_native_bindings_pass":
            j21.get("replicate_count") == 4
            and j21.get("replicate_pass_count") == 4,
        "j21_604_exact_layer_bindings":
            j21.get("canonical_layer_binding_count") == 604,
        "j21_no_rescaling":
...
def final_seal(root: Path) -> dict[str, Any]:
    ...
    checks = {
        ...
        "j21_604_exact_identity_bindings":
            j21.get("canonical_layer_binding_count") == 604,
