...
params = {'landscape': {'main': {'dim': (180, 83), 'res': (1, 1), 'ulc': (0, 0), 'prj': None},
               'layers': {'lyr_0': {'init': {'defined': {'rast': np.ones((83, 180), dtype=float),
                                                         'pts': None,
                                                         'vals': None,
                                                         'interp_method': None}}}}},
 ...
 'model': {'T': 0,
           ...
           'its': {'n_its': 1,
                   ...
                   'rand_genarch': False,
                   'repeat_burn': False},
           'name': 'ARCANA_R436_R42_J14_SAPIENT_3MA_TO_200KA_GEONOMICS_REP1_CONSTRUCTION_PREFLIGHT',
           'seed': {'num': 1894477382}}}
