...
import hashlib,json
root=Path.cwd()
m=json.loads((root/"SOURCE_AUTHORITY_MANIFEST_v0_6D1_R4_36.json").read_text(encoding="utf-8"))
failed=[]
...
out={"stage":"v0.6D1-R4.36",
     "status":"PASS_R436_SOURCE_MANIFEST" if not failed else "BLOCKED_R436_SOURCE_MANIFEST",
