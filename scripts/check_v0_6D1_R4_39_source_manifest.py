...
root=Path.cwd()
manifest=json.loads((root/"SOURCE_AUTHORITY_MANIFEST_v0_6D1_R4_39.json").read_text(encoding="utf-8"))
failed=[]
...
out={
    "stage":"v0.6D1-R4.39",
    "status":"PASS_R439_SOURCE_MANIFEST" if not failed else "BLOCKED_R439_SOURCE_MANIFEST",
