...
$bt = Join-Path $root ".pytest_tmp_r317_checks"
...
$out = Join-Path $root "outputs\v0_6D1_R3_17\FORMAL_AUDIT_CANDIDATE_v0_6D1_R3_17.json"
python (Join-Path $root "scripts\formal_audit_v0_6D1_R3_17_candidate.py") --root $root --out $out
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
