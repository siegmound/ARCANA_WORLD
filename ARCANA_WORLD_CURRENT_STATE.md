...
LATEST_COMPLETED_INTERNAL_STEP: R5.17-B7-A2
LATEST_INTERNAL_VERDICT: PASS_R517_B7_A2_SEMANTIC_BINDING_AND_TEMPORAL_COVERAGE_ADJUDICATED
...
R5.17-B7 is active; B7-A2 is complete and B7-A3 is authorized next.
...
R5_17_B7_STATUS: ACTIVE__A2_COMPLETE

NEXT_OPERATION:
  R5.17-B7-A3
  NATURAL_RESOURCE_COMPONENT_MATERIALIZATION
